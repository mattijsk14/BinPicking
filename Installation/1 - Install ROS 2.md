...
_#### 10. Uninstall ROS 2
If you installed your workspace with colcon as instructed above, “uninstalling” could be just a matter of opening a new terminal and not sourcing the workspace’s setup file. This way, your environment will behave as though there is no Dashing install on your system._

_If you’re also trying to free up space, you can delete the entire workspace directory with:_
```
rm -rf ~/ros2_dashing
```
